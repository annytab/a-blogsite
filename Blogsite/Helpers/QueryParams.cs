...
public class QueryParams
{
    ...
    public static string GetQueryString(QueryParams parameters)
    {
        ...
        if (parameters != null)
        {
            queryString = "?kw=" + HttpContext.Current.Server.UrlEncode(parameters.keywords) + "&sf=" + parameters.sort_field + "&so=" + parameters.sort_order + "&pz=" 
                + parameters.page_size + "&qp=" + parameters.current_page;
        }
