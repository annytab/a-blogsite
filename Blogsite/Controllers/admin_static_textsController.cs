...
namespace Annytab.Blogsite.Controllers
{
    ...
    public class admin_static_textsController : Controller
    {
        ...
        [HttpGet]
        public ActionResult edit(string id = "", string returnUrl = "/admin_static_texts")
        {
            // Get the current domain
            Domain currentDomain = Tools.GetCurrentDomain();
            ViewBag.CurrentDomain = currentDomain;
        ...
        [HttpGet]
        public ActionResult translate(string id = "", string returnUrl = "/admin_static_texts")
        {
            // Get the current domain
            Domain currentDomain = Tools.GetCurrentDomain();
            ViewBag.CurrentDomain = currentDomain;
        ...
        [HttpGet]
        public ActionResult delete(string id = "", string returnUrl = "/admin_static_texts")
        {
            // Get the current domain
            Domain currentDomain = Tools.GetCurrentDomain();
            ViewBag.CurrentDomain = currentDomain;
