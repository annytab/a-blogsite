...
namespace Annytab.Blogsite.Controllers
{
    ...
    public class admin_static_pagesController : Controller
    {
        ...
        [HttpGet]
        public ActionResult edit(Int32 id = 0, string returnUrl = "/admin_static_pages")
        {
            // Get the current domain
            Domain currentDomain = Tools.GetCurrentDomain();
            ViewBag.CurrentDomain = currentDomain;
        ...
        [HttpGet]
        public ActionResult translate(Int32 id = 0, string returnUrl = "/admin_static_pages")
        {
            // Get the current domain
            Domain currentDomain = Tools.GetCurrentDomain();
            ViewBag.CurrentDomain = currentDomain;
        ...
        [HttpGet]
        public ActionResult delete(Int32 id = 0, string returnUrl = "/admin_static_pages")
        {
            // Get the current domain
            Domain currentDomain = Tools.GetCurrentDomain();
            ViewBag.CurrentDomain = currentDomain;
